<?php
// clases/Riego.php
// El modelo de datos entregado no tiene una tabla RIEGO propia: los riegos
// son un tipo de ACTIVIDAD (tabla TIPO_ACTIVIDAD, valor 'Riego').
// Esta clase filtra siempre por ese tipo para no inventar tablas nuevas.
class Riego {

    private PDO $conexion;
    private string $nombreTipo = 'Riego';
