...
<head>
    <meta charset="UTF-8">
    <title>Huertica - Nueva fertilizacion</title>
...
<div class="container mt-2">
    <div class="contenedor-modulo" style="max-width:600px;margin:auto;">
        <h4 class="mb-3">Registrar fertilizacion (nueva)</h4>
        <form method="POST" action="registrar.php" id="formFertilizacion" novalidate>
            <div class="mb-3">
