...
<head>
    <meta charset="UTF-8">
    <title>Huertica - Editar plaga</title>
...
<div class="container mt-2">
    <div class="contenedor-modulo" style="max-width:600px;margin:auto;">
        <h4 class="mb-3">Editar plaga</h4>
        <form method="POST" action="editar.php?id=<?php echo $datos['ID_ACTIVIDAD']; ?>" id="formPlaga" novalidate>
