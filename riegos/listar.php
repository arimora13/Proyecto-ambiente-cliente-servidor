...
<div class="container mt-2">
    <div class="contenedor-modulo">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4>Registro de riegos</h4>
            <a href="registrar.php" class="btn btn-success">+ Nuevo riego</a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="eliminar.php?id=<?php echo $r['ID_ACTIVIDAD']; ?>" class="btn btn-sm btn-danger"
                           onclick="return confirmarEliminar('¿Eliminar este riego?')">Eliminar</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
